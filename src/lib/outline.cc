...
OutlineItem::OutlineItem() : parent(NULL), page(-1), display(true), forwardLinks(false), backLinks(false) {}
...
OutlinePrivate::OutlinePrivate(const settings::PdfGlobal & s) : settings(s), pageCount(0), anchorCounter(0) {
}
